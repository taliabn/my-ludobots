...
class SOLUTION:
	...
	def Generate_Body(self):
		...
		pyrosim.Send_Joint(name = "Torso_FrontLeg" , parent= "Torso" , child = "FrontLeg" , 
							type = "revolute", position = [-0.5, 0.5, 1], jointAxis = "0 1 0") # absolute
		pyrosim.Send_Cube(name="FrontLeg", pos=[0, 0, -0.5] , size=[0.2, 0.2, 1]) # relative

		pyrosim.Send_Joint(name = "Torso_LeftLeg" , parent= "Torso" , child = "LeftLeg" , 
							type = "revolute", position = [0.5, -0.5, 1], jointAxis = "0 1 0") # absolute
		pyrosim.Send_Cube(name="LeftLeg", pos=[0, 0, -0.5] , size=[0.2, 0.2, 1]) # relative

		pyrosim.Send_Joint(name = "Torso_RightLeg" , parent= "Torso" , child = "RightLeg" , 
							type = "revolute", position = [-0.5, -0.5, 1], jointAxis = "0 1 0") # absolute
		pyrosim.Send_Cube(name="RightLeg", pos=[0, 0, -0.5] , size=[0.2, 0.2, 1]) # relative
	...
	def Generate_Brain(self):
		...
		# pyrosim.Send_Motor_Neuron(name = 13, jointName = "Torso_MiddleLeg")
	...
	def Generate_Body(self):
		...
		# joint naming convention: Parent_Child
		pyrosim.Send_Cube(name="Torso", pos=[0, 0, 0.25] , size=[0.5, 0.5, 0.5], mass=0.5)

		pyrosim.Send_Joint( name = "Torso_BackLeg" , parent= "Torso" , child = "BackLeg" , 
							type = "revolute", position = [0, 0.25, 0.5], jointAxis = "0 1 0") # absolute
		pyrosim.Send_Cube(name="BackLeg", pos=[-0.5, 0, 0] , size=[0.75, 0.25, 0.25])

		pyrosim.Send_Joint(name = "BackLeg_BackLower" , parent= "BackLeg" , child = "BackLower" , 
							type = "revolute", position = [-1, 0, 0], jointAxis = "1 0 0") # relative
		pyrosim.Send_Cube(name="BackLower", pos=[0, 0, -0.25] , size=[0.2, 0.2, 0.5], mass = 2) # relative

		pyrosim.Send_Joint( name = "Torso_FrontLeg" , parent= "Torso" , child = "FrontLeg" , 
							type = "revolute", position = [0, -0.25, 0.5], jointAxis = "0 1 0") # absolute
		pyrosim.Send_Cube(name="FrontLeg", pos=[-0.5, 0, 0, ] , size=[0.75, 0.25, 0.25])

		pyrosim.Send_Joint(name = "FrontLeg_FrontLower" , parent= "FrontLeg" , child = "FrontLower" , 
							type = "revolute", position = [-1, 0, 0], jointAxis = "1 0 0") # relative
		pyrosim.Send_Cube(name="FrontLower", pos=[0, 0, -0.25] , size=[0.2, 0.2, 0.5], mass = 2) # relative
	...
	# 	pyrosim.Send_Sensor_Neuron(name = 4, linkName = "FrontLower")
