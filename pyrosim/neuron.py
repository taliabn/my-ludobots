...
class NEURON: 
	...
	def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
		...
		for synapse in synapses.keys(): # keys are tuples
	...
	def Allow_Presynaptic_Neuron_To_Influence_Me(self, current_synapse_value, presynaptic_neuron_value):
		print(current_synapse_value)
		print(presynaptic_neuron_value)
		self.Add_To_Value(presynaptic_neuron_value*current_synapse_value)
